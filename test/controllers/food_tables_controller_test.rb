...
class FoodTablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create food_table' do
    assert_difference('FoodTable.count') do
      post food_tables_url,
           params: { food_table: { Food_name: @food_table.Food_name, Price: @food_table.Price,
                                   Unit: @food_table.Unit } }
    end
  ...
  test 'should update food_table' do
    patch food_table_url(@food_table),
          params: { food_table: { Food_name: @food_table.Food_name, Price: @food_table.Price, Unit: @food_table.Unit } }
